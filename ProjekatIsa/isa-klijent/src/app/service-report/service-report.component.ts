...
export class ServiceReportComponent implements OnInit {
  ...
  currentRentACar : RentACar = new RentACar();
  cars : any;
  minDatum: Date;
    pomoc: string;
    pomocDva: string;
  ...
  constructor(private datePipe: DatePipe, private route: ActivatedRoute,private viewRentalService : ViewRentalCarsService) { }
  ...
  ngOnInit() {
      ...
      this.viewRentalService.currentRentACar.subscribe(
              currentRentACar => 
              {
                this.currentRentACar = currentRentACar;
                console.log(currentRentACar);
                
                this.viewRentalService.getAllCars(this.currentRentACar.id).subscribe(data=>{
                    this.cars = data;
                    console.log(data)
                });
      });
      ...
      this.viewRentalService.getLastWeekReservations(this.currentRentACar.id, this.pomoc).subscribe(data=>{
          this.prethodnaNedelja = data;
          console.log("rezervacije prosle nedelje");
          console.log(data);
          });
      this.viewRentalService.getAllReservations(this.currentRentACar.id).subscribe(data=>{
    ...
    pretraziServise() {
      ...
      this.viewRentalService.getServiceRevenue(this.currentRentACar.id, this.od, this.do).subscribe(data => {
        this.suma = data
  ...
  popuniD() {
      ...
      this.podaci = [
        { data: [pon, uto, sre, cet, pet, sub, ned], label: this.currentRentACar.name }
      ];
  ...
  mesecniClick(){
    ...
    this.podaci = [
      { data: [jan, feb, mart, april, maj, jun, jul, av, sep, okt, nov, dec], label: this.currentRentACar.name }
    ];
  ...
  oceneServisa(){
      ...
      this.dnevni = false;
      this.oceneS = true;
      this.viewRentalService.getAllRatingsService(this.currentRentACar.id).subscribe(data => {
